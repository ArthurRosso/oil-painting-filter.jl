...
# ╔═╡ dba72fd1-4fd7-4ee5-940a-4565d0a41372
begin
	using Statistics
	using Images
end

# ╔═╡ 78471504-5e96-4091-9632-2d10fdb7f0d9
md"""
# Oil Paint Filter
"""

# ╔═╡ a140a649-fca5-4ae0-8b25-b50e7baabda2
md"""
## Imports
"""

# ╔═╡ 7140f39b-02ef-4137-a26f-72b19a4b1bde
md"""
## Main
"""

# ╔═╡ de9ad958-e103-11eb-3f73-2f558ec36a55
url = "https://i.imgur.com/PT3Nh7B.jpeg"

# ╔═╡ 6c823edc-8e9f-48c1-9d1c-4d8c8556bd21
download(url, "flower.jpeg")

# ╔═╡ deac7f11-ef7f-42ab-a7ba-fe1824ac3414
flower = load("flower.jpeg")

# ╔═╡ add659e2-2452-4758-af16-64eb25e43b86
test = copy(flower)

# ╔═╡ 58fa6778-1ce1-4794-af7b-a2e2ce278420
...
# ╔═╡ e1c14cc7-f55e-40e5-9a64-e7037c314857
function kuwahara(I, window_size)    
	# Converts the image to a hsv colorspace
	# (needed to run on colored images)
	hsv = HSV.(I)
	# Gets the brightness value as value[y, x]
	values = channelview(float.(hsv))[3,:,:]
	
	# Cria uma nova imagem de dimensões iguais ao input
    resulting_image = similar(I)
	
	# O tamanho de cada um dos 4 quadrantes do kuwahara
...
# ╔═╡ 27bed088-468e-4cfc-8806-53ee4020f754
[test; kuwahara(test, 21)]
